 ...
 */
public class DBHandler_copy extends SQLiteAssetHelper
{
    ...
    /**
     * WORDS TABLE
     * _id	Vokabel	processed_vocable	tagged_processed_vocable	processed_vocable_soundex	lemma_vocable	tagged_lemma_vocable	tagged_lemma_simple_vocable	Uebersetzung	processed_translation	tagged_processed_translation	processed_translation_soundex	lemma_translation	tagged_lemma_translation	Status	Fundstelle	Band	Wortart	Beispielsatz	Hinweis	BookId	gdex	learner	label	ParseId	beta_si	beta_i	alpha_i	sigma_i	activation	userInfoParseId
     * ======================================================================
     */
     ...
     * ======================================================================
     */
    public static final String SENT_TABLENAME = "sentences_corpus";
     ...
     * Constructor.
     */
    public DBHandler_copy(Context context)
    {
