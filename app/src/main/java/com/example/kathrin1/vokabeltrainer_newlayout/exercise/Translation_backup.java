...
public class Translation_backup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setCurrentItem(ExerciseUtils.setCurrentBook(Translation_backup.this));
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                ExerciseUtils.updateBook(Translation_backup.this, tab);
        ...
        dbManager = DatabaseManager.build(Translation_backup.this);
                        ...
                        // English Input
                            ...
                            if (edit_solution.getText().toString().equals(voc.getVoc())) {
                                ...
                                Feedback feedback = new Feedback(edit_solution.getText().toString(),
                                        voc, true, Translation_backup.this);
        ...
        btn_go_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NavUtils.navigateUpFromSameTask(Translation_backup.this);
            }
        });
    }
    ...
    private void getVocabularyGerman() {
        if (allVocabulary.size() == 0) {
            ...
            BookObject sentence = ExerciseUtils.getTranslationPreferenceSentence(Translation_backup.this, dbManager, voc);
            txt_bsp.setText(ExerciseUtils.deleteWordFromSentence(sentence, voc));
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.item_help:
                Intent intent_help = new Intent(Translation_backup.this, Help.class);
                startActivity(intent_help);
                return (true);
            case R.id.item_home:
                Intent intent_home = new Intent(Translation_backup.this, MainActivity.class);
                startActivity(intent_home);
                return (true);
            case R.id.item_settings:
                Intent intent_setting = new Intent(Translation_backup.this, SettingSelection.class);
